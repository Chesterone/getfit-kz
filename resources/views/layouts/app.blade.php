...
<head>
    ...
    <title>GetFit.kz - полезные и вкусные рецепты</title>
...
<body>
        ...
        <nav class="navbar navbar-expand-md navbar-light navbar-laravel bg-success">
            <div class="container">
                <a class="navbar-brand" href="{{ url('/') }}">
                    ...
                    <strong class="text-white">GetFit.kz</strong>
                </a>
                        ...
                        @else
                            <li class="nav-item dropdown">
                                ...
                                <div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdown">
                                    <a class="dropdown-item" href="{{ route('dashboard') }}">Мои рецепты</a>
                                    <a class="dropdown-item" href="{{ route('recipes.create') }}">Добавить рецепт</a>
    ...
    <footer class="text-muted">
            <div class="container">
              ...
              <p>Сайт создан в качестве проектной работы на базе &copy; Bootstrap, с использованием PHP, HTML, MySQL и CSS.</p>
            </div>
          </footer>
